...
namespace E1___Sosa_Morales.Models.TiposMovimiento;

public class MovementTypeListItem
{
...
public class MovementTypeDetail
{
    [Column("id_movement_type")] public int IdMovementType { get; set; }
    [Column("name")] public string Name { get; set; } = string.Empty;
...
public class MovementTypeSpResult
{
...
public class MovementTypePagedResult
{
