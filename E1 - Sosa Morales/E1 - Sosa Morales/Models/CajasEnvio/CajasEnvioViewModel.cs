...
public class ShipmentBoxListItem { public int IdShipmentBox { get; set; } public int IdShipment { get; set; } public int IdBox { get; set; } public string BoxCode { get; set; } = ""; public decimal? Weight { get; set; } public decimal? Volume { get; set; } public string VehiclePlate { get; set; } = ""; public int TotalCount { get; set; } }
