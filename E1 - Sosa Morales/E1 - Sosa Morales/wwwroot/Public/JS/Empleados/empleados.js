(function () {
    ...
    function loadActiveList() {
        ...
        if (tbody) tbody.innerHTML = '<tr class="emp__loading-row"><td colspan="' + (colCount + 1) + '">Cargando registros...</td></tr>';
    ...
    function loadInactiveList() {
        ...
        if (tbody) tbody.innerHTML = '<tr class="emp__loading-row"><td colspan="' + (inactiveColCount + 1) + '">Cargando...</td></tr>';
