...
public class ProveedoresController : Controller
{
    ...
    public ProveedoresController(ISupplierService service) => _service = service;

    public IActionResult Index()
    {
        return View(new ProveedoresViewModel
        {
    ...
    public async Task<IActionResult> Create(int idDocumentType, string documentNumber, string name, string? phone, string? email, string? address, int? idDistrict)
    {
        try
        {
            var (success, message, id) = await _service.CreateAsync(BuildSaveModel(idDocumentType, documentNumber, name, phone, email, address, idDistrict));
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Update(int id, int idDocumentType, string documentNumber, string name, string? phone, string? email, string? address, int? idDistrict)
    {
        try
        {
            var (success, message) = await _service.UpdateAsync(id, BuildSaveModel(idDocumentType, documentNumber, name, phone, email, address, idDistrict));
    ...
    private static SupplierSaveModel BuildSaveModel(int idDocumentType, string documentNumber, string name, string? phone, string? email, string? address, int? idDistrict)
        => new()
        {
